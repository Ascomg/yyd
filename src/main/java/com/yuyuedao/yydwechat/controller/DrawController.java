...
public class DrawController extends  PublicMethod {
    ...
    @RequestMapping(value = "getDrawDetails",method = RequestMethod.GET)
    @ResponseBody
    public ModelAndView getDrawDetails(@RequestParam("sid") Integer sid,@RequestParam("openid") String openid){
        ModelAndView modelAndView=new ModelAndView();
        try{
            modelAndView.addObject("sid", sid);
            modelAndView.addObject("openid", openid);
            modelAndView.addObject("status", true);
            modelAndView.setViewName("activity_poster_invate");
        }catch(Exception e){
            e.printStackTrace();
            modelAndView.addObject("message", e.getMessage());
            modelAndView.addObject("status", false);
    ...
    @RequestMapping(value = "getDrawDetails",method = RequestMethod.POST)
    @ResponseBody
    public Map<String,Object> getDrawDetail(@RequestParam("sid") Integer sid,@RequestParam("openid") String openid){
        Map<String,Object> rmap=null;
        try{
            rmap=new HashMap<>();
            rmap.put("data",drawService.getDrawDetails(sid,openid));
